    ...
    <div class="my-5 d-flex flex-column align-items-center">
        <div class="my-5 d-flex flex-column align-items-center">
            ...
            @if ($user->id == Auth::user()->id)
                <a data-bs-toggle="modal" data-bs-target="#editProfileModal" class="mb-3 btn btn-dark">Edit Profile</a>
            @endif
            <p class="text-muted fs-6">Register Date: {{ date('d M Y', strtotime($user->created_at)) }}</p>
        </div>
